...
namespace Creation
{
    public class Program
    {
        ...
        public static string AjoutMatiere(List<Matiere> liste)
        {
        ...
        public static string AjoutEleve(List<Eleve> eleves, List<Eleve> participe)
        {
        ...
        public static string AjoutIntervenant(List<Exterieur> liste)
        {
